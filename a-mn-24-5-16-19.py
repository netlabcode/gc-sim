...
def emptyNet():
    ...
    info( net[ 's16m1' ].cmd( 'python3.6 as16m1.py &amp' ) )
    info( net[ 's16m2' ].cmd( 'python3.6 as16m2.py &amp' ) )
    info( net[ 's16m3' ].cmd( 'python3.6 as16m3.py &amp' ) )
    info( net[ 's16m4' ].cmd( 'python3.6 as16m4.py &amp' ) )

    info( net[ 's19m1' ].cmd( 'python3.6 as19m1.py &amp' ) )
    info( net[ 's19m2' ].cmd( 'python3.6 as19m2.py &amp' ) )
    info( net[ 's19m3' ].cmd( 'python3.6 as19m3.py &amp' ) )
    info( net[ 's19m4' ].cmd( 'python3.6 as19m4.py &amp' ) )
    info( net[ 's19m5' ].cmd( 'python3.6 as19m5.py &amp' ) )
